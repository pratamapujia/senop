  ...
  <div class="page-content">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form action="{{ route('dm-berita.store') }}" class="form" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="form-group">
                ...
                <select class="form-select @error('kategori') is-invalid @enderror" name="kategori">
                  ...
                  <option value="Ekskul" {{ old('kategori') == 'Ekskul' ? 'selected' : '' }}>Ekskul</option>
                </select>
                @error('kategori')
                  <div class="invalid-feedback">
                    {{ $message }}
              ...
              <div class="form-group">
                ...
                <div class="form-check mt-3">
                  ...
                  <label class="form-check-label cursor-pointer text-sm" for="masukkanGaleri">
                    Tambahkan juga foto ini ke Halaman Galeri
                  </label>
                </div>
              </div>
            </div>
