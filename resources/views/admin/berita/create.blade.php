  ...
  <div id="main-content">
    ...
    <div class="page-content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form action="{{ route('berita.store') }}" class="form" method="POST" enctype="multipart/form-data" id="formUpload">
            @csrf
            <div class="row">
              <div class="col-12 col-md-6 col-lg-4">
                <div class="form-group">
                  <label class="form-label" for="judul">Judul Berita</label>
                  <input type="text" class="form-control @error('judul') is-invalid @enderror" name="judul" placeholder="Masukkan Judul Berita" value="{{ old('judul') }}">
                  @error('judul')
              ...
              <div class="col-12 col-md-3 col-lg-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('penulis') is-invalid @enderror" name="penulis" placeholder="Masukkan Penulis" value="{{ old('penulis') }}">
                  @error('penulis')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="col-12">
                <div class="form-group">
                  ...
                  <textarea class="@error('berita') is-invalid @enderror" id="default" name="berita" value="{{ old('berita') }}"></textarea>
                  @error('berita')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="col-12 col-md-6 col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('credit') is-invalid @enderror" name="credit" placeholder="Masukkan link sumber berita bila ada" value="{{ old('credit') }}">
                  @error('credit')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
