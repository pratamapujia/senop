    ...
    <div class="page-title">
      <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
          <h3>Data Agenda</h3>
          <p class="text-subtitle text-muted">Data Master untuk agenda kegiatan</p>
        </div>
      </div>
    </div>
    <section class="section">
      ...
      <div class="card">
        <div class="card-header d-flex">
          ...
          <div class="ms-auto">
            <a href="{{ route('dm-agenda.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Data</a>
          </div>
        </div>
        <div class="card-body">
            ...
            <tbody>
              @foreach ($agenda as $item)
                <tr>
                  ...
                  <td>
                    <a href="{{ route('dm-agenda.edit', $item->id) }}" class="btn icon icon-left btn-primary"><i class="fa-regular fa-pen-to-square"></i> Edit</a>
                    ...
                    <div class="modal-content border-0 shadow">
                      ...
                      <div class="modal-body text-center pb-4 px-4">
                        ...
                        <p class="text-muted mb-0">
                          Apakah Anda yakin ingin menghapus agenda <strong>{{ $item->judul }}</strong>? <br>
                      ...
                      <div class="modal-footer border-0 justify-content-center pt-0 pb-4">
                        ...
                        <form action="{{ route('dm-agenda.destroy', $item->id) }}" method="POST" class="m-0">
                          @csrf
                          @method('DELETE')
