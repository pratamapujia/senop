  ...
  <div id="main-content">
    ...
    <div class="page-content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form action="{{ route('agenda.update', $agenda->id_agenda) }}" class="form" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
              <div class="col-12">
              ...
              <div class="col-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('keterangan') is-invalid @enderror" name="keterangan" placeholder="Keterangan" value="{{ old('keterangan', $agenda->keterangan) }}">
                  @error('keterangan')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
