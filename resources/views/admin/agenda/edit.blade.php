...
@section('main')
  ...
  <div class="page-content">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <form action="{{ route('dm-agenda.update', $agenda->id) }}" class="form" method="POST" enctype="multipart/form-data">
          @csrf
          @method('PUT')
          <div class="row">
            <div class="col-12 col-md-6 col-lg-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('judul') is-invalid @enderror" name="judul" placeholder="Masukkan Judul" value="{{ old('judul', $agenda->judul) }}">
                @error('judul')
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('tempat') is-invalid @enderror" name="tempat" placeholder="Masukkan Tempat" value="{{ old('tempat', $agenda->tempat) }}">
                @error('tempat')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="form-group">
                ...
                <input type="date" class="form-control @error('tanggal') is-invalid @enderror" name="tanggal" value="{{ old('tanggal', $agenda->tanggal) }}">
                @error('tanggal')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
            ...
            <div class="col-12 col-md-6 col-lg-12">
              <div class="form-group">
                ...
                <input type="hidden" name="deskripsi" id="input_deskripsi" value="{{ old('deskripsi', $agenda->deskripsi ?? '') }}">

                <!-- Wadah editor Quill -->
                <!-- Kita cetak value-nya di sini agar saat edit/error, teksnya kembali muncul -->
                <div id="full" class="@error('deskripsi') is-invalid @enderror">{!! old('deskripsi', $agenda->deskripsi ?? '') !!}</div>
