  ...
  <div id="main-content">
    ...
    <div class="page-content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form action="{{ route('testimoni.store') }}" class="form" method="POST" enctype="multipart/form-data" id="formUpload">
            @csrf
            <div class="row">
              <div class="col-lg-6 col-md-6 col-12">
                <div class="form-group">
                  <label class="form-label" for="nama">Nama Alumni</label>
                  <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" placeholder="Masukkan Nama Alumni" value="{{ old('nama') }}">
                  @error('nama')
