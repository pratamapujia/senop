...
@section('main')
          ...
          <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
            <ol class="breadcrumb">
              <li class="breadcrumb-item">
                <a href="{{ route('dm-jurusan.index') }}">Data Jurusan</a>
              </li>
  ...
  <div class="page-content">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <form action="{{ route('dm-jurusan.store') }}" class="form" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('kode_jurusan') is-invalid @enderror" name="kode_jurusan" id="kode_jurusan" placeholder="Contoh: DKV" value="{{ old('kode_jurusan') }}">
                @error('kode_jurusan')
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('nama_jurusan') is-invalid @enderror" name="nama_jurusan" id="nama_jurusan" placeholder="Contoh: Desain Komunikasi Visual"
            ...
            <div class="col-12 mt-3">
              <div class="form-group">
                ...
                <textarea class="form-control @error('deskripsi_hero') is-invalid @enderror" name="deskripsi_hero" id="deskripsi_hero" rows="3"
                  placeholder="Kalimat singkat yang tampil di banner atas halaman jurusan">{{ old('deskripsi_hero') }}</textarea>
            ...
            {{-- Prospek Karier (repeater) --}}
            <div class="col-12 mt-3">
              <div class="form-group">
                <label class="form-label">Prospek Karier</label>
                <p class="text-muted" style="font-size: 12px;">Tambahkan daftar profesi/prospek karier yang akan tampil di sidebar halaman jurusan.</p>

                <div id="peluang-wrapper">
                  @php $peluangLama = old('peluang_kerja', []); @endphp
                  @forelse ($peluangLama as $peluang)
            ...
            <div class="col-12 mt-3">
              <div class="form-group mb-4 p-4 border border-dashed rounded-3" style="background:#f8f9fa;">
                ...
                <p class="text-muted mb-3" style="font-size: 12px;">
                  Anda bisa memilih lebih dari satu foto. Foto yang diunggah di sini akan otomatis masuk ke menu Galeri dengan kategori jurusan ini.
                </p>
            ...
            <div class="col-6 mt-2">
              <button type="reset" class="btn btn-secondary icon icon-left btn-block w-100">
...
@section('js')
  ...
  <script>
    ...
    // Submit guard: sinkronkan sekali lagi tepat sebelum submit,
    // jaga-jaga kalau event text-change terakhir belum sempat terpasang
    document.querySelector('form').addEventListener('submit', function() {
      document.getElementById('input_konten').value = quill.root.innerHTML;
    });

    // Repeater Prospek Karier
