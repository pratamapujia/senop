      ...
      <div class="col-md-8">
        ...
        <div class="row my-4">
          <div class="col-md-6 col-sm-6 py-2" data-aos="fade-up" data-aos-delay="100">
            ...
            <ul class="nav flex-column">
              <li class="nav-item">
                <a href="tel:0318915186" class="nav-link ps-0 pb-0"><i class="bi bi-telephone-fill"></i> 031-8915186</a>
              </li>
              <li class="nav-item">
                <a href="https://wa.me/6285785249111" class="nav-link ps-0 pb-0"><i class="bi bi-whatsapp"></i> 085785249111</a>
              </li>
              <li class="nav-item">
